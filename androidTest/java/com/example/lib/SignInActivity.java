...
//public class SignInActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(editID.getText().toString().equals("admin") &&
                        editPass.getText().toString().equals("admin"))
                {
                    Toast.makeText(b1.getContext(), "Signing In...",Toast.LENGTH_SHORT).show();
                }
                else
                    {
                    Toast.makeText(b1.getContext(), "Wrong Credentials",Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editID = "michealnsadah@gmail.com";
        editPass = "Password";
        //editPass = (TextInputLayout) findViewById(R.id.editPass);
        //firebaseAuth=FirebaseAuth.getInstance();
        buttonSignIn = (Button) buttonSignIn.findViewById();
        //toSignUp = (TextView) buttonSignIn.findViewById();
